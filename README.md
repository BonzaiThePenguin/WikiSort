...
This algorithm is based on the one described in <a href="http://www.researchgate.net/publication/225153768_Ratio_Based_Stable_In-Place_Merging">"Ratio based stable in-place merging", by Pok-Son Kim and Arne Kutzner</a>, but it uses a simplified design. It is currently 3-4x slower than std::stable_sort() with random input, although in special cases it is up to 10x faster. Allowing it to use a dynamically allocated buffer would of course remove this disparity, but that's not the goal of this project!
